...
SECRET_KEY = 'django-insecure-wb6si#6a(fiq8n-phq=6o4uw=)_6pisnrqs(r3-wjg-(9zm5-u'
...
MIDDLEWARE = [
    ...
    'Job.middleware.BlockAdminOnPort8000Middleware',
]
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'mehta',
        'HOST': '127.0.0.1',
        'PORT': '3307',   # 👈 change if you used 3307
    }
}
